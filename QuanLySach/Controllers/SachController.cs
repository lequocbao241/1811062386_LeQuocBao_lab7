...
namespace QuanLySach.Controllers
{
    public class SachController : ApiController
    {
        ...
        new Sach { Id =2 , Title =" Pro ÁP.Net MVC5 ", AuthorName =  "Adam Freeman", Content="The ASP.NET MVC 5 Framework is the latest evolution of Microsoft’s ASP.NET web platform.", Price =3.75M},
        };
